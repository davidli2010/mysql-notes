...
- [Writing a Custom Storge Engine](writing-a-custom-storage-engine.md)
    ...
    - [Supporting Indexing](supporting-indexing.md)
        - [Getting Index Information During CREATE TABLE Operations](getting-index-information-during-create-table-operations.md)
        - [Creating Index Keys](creating-index-keys.md)
        - [Parsing Key Information](parsing-key-information.md)
        - [Providing Index Information to the Optimizer](providing-index-information-to-the-optimizer.md)
        - [Implementing Index Methods](implementing-index-methods.md)